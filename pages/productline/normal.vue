...
export default {
	...
	data() {
		return {
			sModule: "productline",
			sModel: "productline",
			tableinfo: ["productline","plt","plct"],
			sParameter: "",

			uidesc_add: [
				{"UiLabel":"产线名称","DbColumn":"pltName","ControlType":"text","UiPlaceholder":"请输入...","Value":"","UiStyle":"","UiLabelAlert":"","DataFilter":[],"DataCheck":[]},
				{"UiLabel":"生产力系数","DbColumn":"pltProductivity","ControlType":"text","UiPlaceholder":"请输入...","Value":"","UiStyle":"","UiLabelAlert":"","DataFilter":[],"DataCheck":[]},
			],

			uidesc_normal: [
				{"UiLabel":"编号","DbColumn":"pltNumCode","ControlType":"label","UiPlaceholder":"请输入...","Value":"","UiStyle":"","UiLabelAlert":"","DataFilter":[],"DataCheck":[]},
				{"UiLabel":"产线名称","DbColumn":"pltName","ControlType":"text","UiPlaceholder":"请输入...","Value":"","UiStyle":"","UiLabelAlert":"","DataFilter":[],"DataCheck":[]},
				{"UiLabel":"生产力系数","DbColumn":"pltProductivity","ControlType":"text","UiPlaceholder":"请输入...","Value":"","UiStyle":"","UiLabelAlert":"","DataFilter":[],"DataCheck":[]},
			],
