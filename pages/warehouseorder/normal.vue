...
export default {
	...
	data() {
		return {
			sModule: "warehouse",
			sModel: "warehouseorder",
			tableinfo: ["warehouseorder","whot","whoct"],
			sParameter: "",

			uidesc_add: [
				{"UiLabel":"类型","DbColumn":"whotType","ControlType":"radio","UiPlaceholder":"请输入...","Value":"","UiStyle":"","UiLabelAlert":"","DataFilter":[],"DataCheck":[],"Options":[{"Text":"入库","Value":"0"},{"Text":"出库","Value":"1"}]},
				{"UiLabel":"仓库ID","DbColumn":"whotWarehouseID","ControlType":"text","UiPlaceholder":"请输入...","Value":"","UiStyle":"","UiLabelAlert":"","DataFilter":[],"DataCheck":[]},
				{"UiLabel":"产品ID","DbColumn":"whotProductID","ControlType":"text","UiPlaceholder":"请输入...","Value":"","UiStyle":"","UiLabelAlert":"","DataFilter":[],"DataCheck":[]},
				{"UiLabel":"数量","DbColumn":"whotCount","ControlType":"text","UiPlaceholder":"请输入...","Value":"","UiStyle":"","UiLabelAlert":"","DataFilter":[],"DataCheck":[]},
			],

			uidesc_normal: [
				{"UiLabel":"编号","DbColumn":"whotNumCode","ControlType":"label","UiPlaceholder":"请输入...","Value":"","UiStyle":"","UiLabelAlert":"","DataFilter":[],"DataCheck":[]},
				{"UiLabel":"类型","DbColumn":"whotType","ControlType":"radio","UiPlaceholder":"请输入...","Value":"","UiStyle":"","UiLabelAlert":"","DataFilter":[],"DataCheck":[],"Options":[{"Text":"入库","Value":"0"},{"Text":"出库","Value":"1"}]},
				{"UiLabel":"仓库ID","DbColumn":"whotWarehouseID","ControlType":"label","UiPlaceholder":"请输入...","Value":"","UiStyle":"","UiLabelAlert":"","DataFilter":[],"DataCheck":[]},
				{"UiLabel":"产品ID","DbColumn":"whotProductID","ControlType":"label","UiPlaceholder":"请输入...","Value":"","UiStyle":"","UiLabelAlert":"","DataFilter":[],"DataCheck":[]},
				{"UiLabel":"数量","DbColumn":"whotCount","ControlType":"label","UiPlaceholder":"请输入...","Value":"","UiStyle":"","UiLabelAlert":"","DataFilter":[],"DataCheck":[]},
			],
